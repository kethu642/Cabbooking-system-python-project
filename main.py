...
def RegisterPage():
    ...
    canvas.create_rectangle(90,100,430,550,fill="#00FFFF",outline="white")
    ...
    Regbutton=Button(canvas,text="Register",width=10,fg="white",bg="#000",font=("Arial",13,'bold'),command=RegisterNow)
    canvas.create_window(200,500,window=Regbutton)
    Loginbutton=Button(canvas,text="Login",fg="white",bg="black",bd=0,font=("Arial",13,'bold'),command=loginpage)
...
def feedpage():
    ...
    global feedEntry
    canvas.delete('all')
    gifimg=PhotoImage(file="background.png")
...
def forgotpage():
    ...
    backgroundIMG=PhotoImage(file="background.png")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="#00FFFF",outline="white")
    ...
    Resetbutton=Button(canvas,text="Reset Password",width=15,fg="white",bg="#000",font=("Arial",13,'bold'),command=forgotpass)
...
def cabbook():
    ...
    backgroundIMG=PhotoImage(file="background2.png")
    canvas.create_image(0,100,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(0,0,1366,200,fill="#00FFFF",outline="blue")
    canvas.create_rectangle(590,200,890,500,fill="white")
    canvas.create_text(20,30,text="nice cabs",fill='black',font=("bauhaus 93",25),anchor=NW)
    canvas.create_text(20,60,text="The best a cabs ",fill='black',font=("Lucida calligraphy",15),anchor=NW)
    ...
    canvas.create_text(620,100,text="From",fill='black',font=("Arial",10))
    canvas.create_text(610,170,text="To",fill='black',font=("Arial",10))
    ...
    canvas.create_text(1200,50,text="Welcome "+loggedname,font=("Arial",15),fill="black")
    canvas.pack()
    detbutton=Button(canvas,text="View Past booking",width=15,fg="white",bg="#000",bd=0,font=("Arial",13,'bold'),command=viewbooking)
    ...
    cpbutton=Button(canvas,text="Change your Password",width=20,fg="white",bg="#000",bd=0,font=("Arial",13,'bold'),command=changepasswordpage)
    canvas.create_window(1200,110,window=cpbutton)
    revbutton=Button(canvas,text="Review",width=20,fg="white",bg="#000",bd=0,font=("Arial",13,'bold'),command=feedpage)
...
def adminloginpage():
    ...
    backgroundIMG=PhotoImage(file="background.png")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="#00FFFF",outline="blue")
    ...
    Loginbutton=Button(canvas,text="Login",width=10,fg="white",bg="#000",font=("Arial",13,'bold'),command=cadminlogin)
...
def changepasswordpage():
    ...
    backgroundIMG=PhotoImage(file="background.png")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(600,150,1000,550,fill="#00FFFF",outline="white")
    ...
    Resetbutton=Button(canvas,text="Reset Password",width=15,fg="white",bg="#000",font=("Arial",13,'bold'),command=changepass)
...
def loginpage():
    ...
    canvas.create_window(300,300,window=userEntered)
    canvas.create_window(300,350,window=passEntered)
    Loginbutton=Button(canvas,text="Login",width=10,fg="white",bg="#000",font=("Arial",13,'bold'),command=validate)
    canvas.create_window(200,450,window=Loginbutton)
    Regbutton=Button(canvas,text="Register",fg="white",bg="black",bd=0,font=("Arial",13,'bold'),command=RegisterPage)
